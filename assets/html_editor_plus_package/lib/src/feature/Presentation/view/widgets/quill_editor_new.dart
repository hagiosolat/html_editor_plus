...
import '../../../../../html_editor_plus_package.dart';
...
import '../../../../core/webviewx/src/webviewx_plus.dart';
...
class QuillEditorNewState extends ConsumerState<QuillEditorNew> {
  ...
  @override
  void initState() {
    // ref.read(editorControllerProvider.notifier).getJavaScriptFunc();
